            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Articals Table</h4>
                                            ...
                                            @foreach ($allArticals as $item)
                                                <tr data-id="{{ $item->id }}">
                                                    ...
                                                    <td style="word-break: break-all">
                                                        {{ Str::limit($item->body, 60, $end = '...') }}

                                                    </td>
                                                    <td>
                                                        <img src="{{ $item->image == null ? asset('Website_Assets/assets/images/NoImageAvailable.jpg') : asset('storage/' . $item->image) }}"
                                                            alt="{{ $item->name }}"
                                                            style="border-radius: 0px;width: 100px;height: 100px;" />
                                                    </td>
                                                    <td class="py-1">
                                                        <img src="{{ asset('Website_Assets/assets/images/userImageDefault.jpg') }}"
                                                            alt="{{ $item->admin->name }}"
